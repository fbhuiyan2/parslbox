...
# --- Polaris Specific Details ---
# Each Polaris node has 4 NVIDIA A100 GPUs.
GPUS_PER_NODE = 4

# Each Polaris node has 32 physical cores (64 with hyperthreading).
# We will base worker calculations on physical cores for performance.
CORES_PER_NODE = 32
...
def _detect_polaris_resources() -> tuple[int, int]:
    """
...
def get_config(run_dir: Path, retries: int = 0) -> Config:
    ...
    """
    nodes, total_gpus = _detect_polaris_resources()
